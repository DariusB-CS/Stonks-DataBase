...
ALTER TABLE "public"."tracked_stocks" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."tracked_stocks" TO "anon";
GRANT ALL ON TABLE "public"."tracked_stocks" TO "authenticated";
GRANT ALL ON TABLE "public"."tracked_stocks" TO "service_role";
